...
import { UseThreeJsSceneProps, ThreeJsSceneRefs } from './types';
import { setupLighting, setupRenderer, resizeRenderer } from './sceneUtils';
import { loadModel } from './modelLoader';

export function useThreeJsSceneCore({
  modelSrc,
  containerRef,
  onModelLoaded,
  onHotspotUpdate,
  ...
  // Expose the ThreeJS objects for external use
  ...
  return {
    ...
    resizeRendererToDisplaySize,
    retryLoadModel,
    // focusCameraOnPosition will be injected by the top-level hook
  };
}
